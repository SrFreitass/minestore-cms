...
export function Card({ item, direction = 'col', hideButton, showProduct = true }: CardProps) {
    ...
    return (
        ...
        >
            <span className="max-w-44 z-10 absolute -mt-[17.6px] hidden rounded-xl bg-[#0A0A0C] p-2 font-medium text-white text-sm group-hover:block group-hover:animate-up">
                Clique p/ saber mais
